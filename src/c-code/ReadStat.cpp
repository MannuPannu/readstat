#include "src_statistics_ReadStat.h"   // this header file was generated by javah
...
jobject createJavaStatisticsObject(char *fileName, polystatistics *polyS, JNIEnv *env);
char* getPolyDir();
...
JNIEXPORT jobject JNICALL Java_src_statistics_ReadStat_getStatistics (JNIEnv *env, jobject obj)
{
  ...
  printf("Try to find class Statistics");
  jclass statClass = env->FindClass("src/statistics/Statistics");
  ...
  while(it != entryList.end())
      ...
      if (polyS == MAP_FAILED)
	{
      ...
      returnObject = createJavaStatisticsObject(fileNamePtr, polyS, env);

      it++;

      //Add it to the statistic array
    ...
    jclass arrayClass = env->FindClass("src/statistics/Array");
    ...
    constructorMethodID = env->GetMethodID(arrayClass,
					      "<init>","([Lsrc/statistics/Statistics;I)V");

    printf("Created Array object\n");
    jobject statObj;
...
jobject createJavaStatisticsObject(char *fileNamePtr, polystatistics *polyS, JNIEnv *env)
{
    ...
    //Create a Statistics class object
    jclass statClass = env->FindClass("src/statistics/Statistics");

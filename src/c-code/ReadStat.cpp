#include "statistics_ReadStat.h"   // this header file was generated by javah
...
JNIEXPORT jobject JNICALL Java_statistics_ReadStat_getStatistics (JNIEnv *env, jobject obj)
{
  ...
  jclass statClass = env->FindClass("statistics/Statistics");
  ...
  while(it != entryList.end())
    ...
    jclass arrayClass = env->FindClass("statistics/Array");
    ...
    constructorMethodID = env->GetMethodID(arrayClass,
					      "<init>","([Lstatistics/Statistics;I)V");
